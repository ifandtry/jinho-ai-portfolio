  ...
  return (
    <Link className="card-perspective block h-full" href={`/projects/${project.slug}`}>
      <MotionDiv
        ...
        className={`premium-shadow group relative flex h-full min-h-[330px] flex-col overflow-hidden rounded-[1.45rem] border border-white/10 bg-ink p-6 text-white ${
          featured ? "md:min-h-[370px] md:w-[330px]" : "md:min-h-[350px] md:w-[270px]"
        }`}
      >
        ...
        <div className="relative mt-auto">
          ...
          <div className="h-16 rounded-2xl border border-white/10 bg-[linear-gradient(135deg,oklch(0.34_0.11_262_/_0.45),oklch(0.16_0.02_255_/_0.35))] p-4">
